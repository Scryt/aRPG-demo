...
public class EnemyControl : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            enemy_CurrentState = SetEnemyState(enemy_CurrentState, enemy_LastState, enemyToPlayerDistnace);
    ...
    EnemyState SetEnemyState(EnemyState curState, EnemyState lastState, float enemyToPlayerDis)
    {
        ...
        if (initialDistance > followDistance)
        {
            ...
            // STOP ENEMY ON COLISION AND CHECK IF ENEMY STOPS THEN ATTACK
        }
    ...
    void GetStateControl(EnemyState curState)
    {
        ...
        else if (curState == EnemyState.GOBACK)
        {
            ...
            if (Vector3.Distance(targetPosition, initialPosition) <= 1f)
            {
